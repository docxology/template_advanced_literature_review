...
\begin{frame}[allowframebreaks]{Results: Hypotheses and Evidence}
...
\begin{frame}[allowframebreaks]{Configured questions}
\phantomsection\label{configured-questions}
\begin{itemize}
\tightlist
\item
